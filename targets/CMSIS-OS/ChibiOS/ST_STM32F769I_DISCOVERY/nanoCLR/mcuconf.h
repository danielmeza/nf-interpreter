...
#define STM32_PLLR_VALUE                    2 //NOT IN LATEST VERSION, KEEPING JUST INCASE
...
#define STM32_WSPI_QUADSPI1_PRESCALER_VALUE 2 //NOT IN LATEST VERSION, KEEPING JUST INCASE
